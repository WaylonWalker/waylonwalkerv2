        ...
        <div id="content" style={{ maxWidth: '1200px', margin: 'auto' }}>
          <section>
            ...
            <p style={paragraphStyle}>
              I am a <span style={{display: 'inline-block'}}><span style={traitStyle}><strong>{this.state.traits[this.state.trait]}</strong></span></span>  of 2 energetic Children.  They are the ones that get me out of bed in the morning.
