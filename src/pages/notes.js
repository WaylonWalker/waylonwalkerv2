    ...
    return (
      <Layout>
        <Helmet
          meta={[
            { property: 'og:type', name: 'og:type', content: 'website' },
            {
              property: 'og:title',
              name: 'og:title',
              content: "Waylon Walker's Notes Feed",
            },
            {
        ...
        <BlogPageStyles>
          <h1>Notes</h1>
          <p>
            These are less developed ideas of larger topics that may eventually
            lead to a fully fledged blog post. This gives me a dumping ground to
            put ideas and continually develop them.
          </p>
